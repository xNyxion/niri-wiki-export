...
Also see the [gestures configuration](./Configuration:-Gestures) wiki page.
...
You can customize the look of the window insertion preview in the [`insert-hint` layout config](./Configuration:-Layout#insert-hint).
