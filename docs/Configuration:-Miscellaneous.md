...
Settings for the [Overview](./Overview).
...
Settings here mirror the normal [`shadow` config in the layout section](./Configuration:-Layout#shadow), so check the documentation there.
